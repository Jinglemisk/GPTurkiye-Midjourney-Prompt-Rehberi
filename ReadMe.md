...
Eğer prompt’ları istediğimiz biçimde İngilizce’de düşünmekte zorlanıyorsak, [DeepL](https://www.deepl.com/translator) gibi bir tercüman kullanarak istediklerimizi Midjourney’e aktarabiliriz. Bu rehberde aktarmaya çalıştığımız prompt yazım mantığına uyulduğu takdirde, Midjourney kendisine veirlen Türkçe’den çevrilmiş İngilizce prompt’ları yorumlamakta güçlük çekmeyecektir. Midjourney kullanmak için katılacağınız Discord kanalında da beğendiğiniz görsellerin prompt'Larını DeepL aracılığıyla Türkçe'ye çevirebilir, genel prompt mantığının işleyişine daha hakim olabilirsiniz.
